...
/* allocate_routing-resource_tree_timing_structures */
void alloc_route_tree_timing_structs(void)
{
    /* Allocates any structures needed to build the routing trees. */
    /* TODO: why did the rt_node_free_list appeared twice? Could the *
     * second rt_node_free_list be rt_edge_free_list? */
