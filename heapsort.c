...
static void add_to_sort_heap(int* heap, double* sort_values, int index,
                             int heap_tail);

static int get_top_of_heap_index(int* heap, double* sort_values, int
                                 heap_tail);


/**************** Subroutine definitions *********************/
/* Sorting sort_index[nelem] elements according to sort_values */
void heapsort(int* sort_index, double* sort_values, int nelem)
{
