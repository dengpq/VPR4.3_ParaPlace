...
grid_tile_t** bin_grids;   /* Architecture blocks list */
                          ...
                          double* constant_net_delay)
{
    ...
    *constant_net_delay = -1;
    ...
    if (argc < 5) {
        ...
        printf("\t[-timing_tradeoff <double>]\n");
        printf("\t[-recompute_crit_iter <int>]\n");
        printf("\t[-inner_loop_recompute_divider <int>]\n");
        printf("\t[-td_place_exp_first <double>]\n");
        printf("\t[-td_place_exp_last <double>]\n");
        printf("\nRouter Options:  [-max_router_iterations <int>] "
               "[-bb_factor <int>]\n");
        printf("\t[-initial_pres_fac <double>] [-pres_fac_mult <double>]\n"
               "\t[-acc_fac <double>] [-first_iter_pres_fac <double>]\n"
    ...
    while (i < argc) {
        ...
        if (strcmp(argv[i], "-recompute_crit_iter") == 0) {
            placer_opts->recompute_crit_iter = read_int_option(argc, argv, i); /* 0 */
        ...
        if (strcmp(argv[i], "-timing_analyze_only_with_net_delay") == 0) {
            ...
            *constant_net_delay = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-init_t") == 0) {
            annealing_sched->init_t = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-exit_t") == 0) {
            annealing_sched->exit_t = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-place_cost_exp") == 0) {
            placer_opts->place_cost_exp = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-td_place_exp_first") == 0) {
            placer_opts->td_place_exp_first = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-td_place_exp_last") == 0) {
            placer_opts->td_place_exp_last = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-first_iter_pres_fac") == 0) {
            router_opts->first_iter_pres_fac = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-initial_pres_fac") == 0) {
            router_opts->initial_pres_fac = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-pres_fac_mult") == 0) {
            router_opts->pres_fac_mult = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-acc_fac") == 0) {
            router_opts->acc_fac = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-astar_fac") == 0) {
            router_opts->astar_fac = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-max_criticality") == 0) {
            router_opts->max_criticality = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-criticality_exp") == 0) {
            router_opts->criticality_exp = read_double_option(argc, argv, i);
        ...
        if (strcmp(argv[i], "-bend_cost") == 0) {
            router_opts->bend_cost = read_double_option(argc, argv, i);
