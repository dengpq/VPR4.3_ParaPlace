...
static double clb_width, pin_size;
...
static void draw_pin_to_chan_edge(int pin_node, int chan_node, int itrack,
                                  boolean mark_conn);
static void draw_x(double x, double y, double size);
...
void init_draw_coords(double clb_width_val)
{
                           ...
                           boolean buffered)
{
    ...
    const double switch_rad = 0.15;
    double magnitude, xcen, ycen, xdelta, ydelta, xbaseline, ybaseline;
    double xunit, yunit;
    t_point poly[3];
